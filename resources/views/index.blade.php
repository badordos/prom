                        ...
                        <div class="testi-box-warp">
                            ...
                            <div>
                                <div class="testimonial">
                                    ...
                                    <a href="{{route('catalog', $types->where('title', 'Сварные арматурные сетки')->first())}}"
                                       class="site-btn sb-white mr-4 mb-3">Посмотреть в каталоге</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testi-box-warp">
                            ...
                            <div>
                                <div class="testimonial">
                                    ...
                                    <a href="{{route('catalog', $types->where('title', 'Перильные ограждения и отбойники')->first())}}"
                                       class="site-btn sb-white mr-4 mb-3">Посмотреть в каталоге</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testi-box-warp">
                            ...
                            <div>
                                <div class="testimonial">
                                    ...
                                    <a href="{{route('catalog', $types->where('title', 'Рамы РМП')->first())}}"
                                       class="site-btn sb-white mr-4 mb-3">Посмотреть в каталоге</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testi-box-warp">
                            ...
                            <div>
                                <div class="testimonial">
                                    ...
                                    <a href="{{route('catalog', $types->where('title', 'Опоры светофорные')->first())}}"
                                       class="site-btn sb-white mr-4 mb-3">Посмотреть в каталоге</a>
                                </div>
                            </div>
                        </div>
